...
class ListaHotelesHome extends StatelessWidget {
  final String searchQuery;

  const ListaHotelesHome({super.key, required this.searchQuery});

  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<Hotel>>(
      future: obtenerTodosLosHoteles(),
      builder: (context, snapshot) {
        ...
        final List<Hotel> filteredHoteles = hoteles.where((hotel) {
          ...
          final bool matchesUbicacion =
              hotel.ubicacion.toLowerCase().contains(query);
